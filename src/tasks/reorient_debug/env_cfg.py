...
UW_PEG_USD_PATH = f"{UWLAB_CLOUD_ASSETS_DIR}/Props/Custom/Peg/peg.usd"

# OBJ_CONTACT_SENSOR_FILTER_PRIM_PATHS_EXPR = "{ENV_REGEX_NS}/Object/baseLink"

OBJ_CONTACT_SENSOR_FILTER_PRIM_PATHS_EXPR = "{ENV_REGEX_NS}/Object"
