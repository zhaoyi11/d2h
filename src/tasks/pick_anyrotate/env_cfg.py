...
from src.tasks.common.env_cfg import HrlActionsCfg, configure_contact_physics, configure_fingertip_contacts, configure_success_visualization, fingertip_contact_observation, fingertip_transforms_cfg, get_visdex_usd_paths, ground_plane_cfg, light_cfg, table_cfg
...
@configclass
class DexsuiteFrankaLeapAnyRotateHrlEnvCfg(ManagerBasedRLEnvCfg):
    """Pick an object and reach six sampled in-hand orientations."""
