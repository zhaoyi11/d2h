...
import src.tasks.pick_insert_debug.mdps as mdp
...
class SceneCfg(InteractiveSceneCfg):
    ...
    object: RigidObjectCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.45, 0.2, 0.3), rot=(1.0, 0.0, 0.0, 0.0)),
    )
...
class CommandsCfg:
    ...
    object_pose = mdp.HandFrameReOrientationCommandCfg(
        asset_name="object",
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        object_pos_b = ObsTerm(
            ...
            params={"body_asset_cfg": SceneEntityCfg("robot", body_names="base"), "object_cfg": SceneEntityCfg("object")},
        )
    ...
    class LowLevelObsCfg(ObsGroup):
        ...
        gravity_dir = ObsTerm(func=mdp.gravity_dir_body_b, params={"body_asset_cfg": SceneEntityCfg("robot", body_names="base")})
...
class DexsuiteFrankaLeapInsertHrlEnvCfg(FrankaLeapMixinCfg, DexsuiteInsertEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.events.reset_object_relative_to_hand = EventTerm(
