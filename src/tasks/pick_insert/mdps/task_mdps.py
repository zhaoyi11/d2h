...
class CommandHandBaseCuroboMpcAction(ActionTerm):
    ...
    def reset(self, env_ids=None) -> None:
        ...
        # damping for the OSC (effort control), which leaves set_joint_position_target with no
        # drive to act on. Restore position gains here (after startup gain-randomization).
