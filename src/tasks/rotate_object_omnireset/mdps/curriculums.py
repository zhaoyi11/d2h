"""Adaptive reset-state curriculum for rotate-object OmniReset."""
...
class ResetStateCurriculum(ManagerTermBase):
    """Expand or contract the per-goal reset band from completed-episode success."""
