...
import src.env.tasks.anygrasp.base_env_cfg as env_cfg
...
@configclass
class AllegroCubeEnvCfg(env_cfg.InHandObjectEnvCfg):
...
class AllegroCubeNoVelObsEnvCfg(AllegroCubeEnvCfg):
    def __post_init__(self):
        ...
        self.observations.policy = env_cfg.ObservationsCfg.NoVelocityKinematicObsGroupCfg()
