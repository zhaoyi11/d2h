...
from src.policy.high_level.utils import (  # noqa: E402
...
def main() -> None:
    ...
    # Note the anchor orientation stays fixed while the object goal yaws through the twist -- the twist
    # is executed in-hand by the frozen policy, not by rolling the wrist.
