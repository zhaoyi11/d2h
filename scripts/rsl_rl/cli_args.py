...
def add_rsl_rl_args(parser: argparse.ArgumentParser):
    ...
    arg_group.add_argument(
        ...
        type=str,
        default=None,
        help="WandB run/model path for loading checkpoints in play mode.",
    )
    arg_group.add_argument(
        "--wandb_entity",
        "--wandb-entity",
        ...
        type=str,
        default=None,
        help="WandB entity (team/user) used when tracking runs.",
    )
    arg_group.add_argument(
        "--wandb_name",
        "--wandb-name",
        ...
        type=str,
        default=None,
        help="WandB run name used when tracking runs.",
    )
    arg_group.add_argument(
        "--track",
        type=lambda x: bool(strtobool(x)),
        ...
        nargs="?",
        const=True,
        help="If enabled, track this experiment with Weights and Biases.",
    )
...
def update_rsl_rl_cfg(agent_cfg: RslRlOnPolicyRunnerCfg, args_cli: argparse.Namespace):
    ...
    if agent_cfg.logger in {"wandb", "neptune"} and hasattr(args_cli, "log_project_name") and args_cli.log_project_name:
