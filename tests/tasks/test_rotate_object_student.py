...
def test_rotate_object_student_task_contract() -> None:
    ...
    runner = (ROOT / "src/tasks/rotate_knob_student/rsl_rl_ppo_cfg.py").read_text()
    ...
    assert "from src.tasks.rotate_knob.rsl_rl_ppo_cfg import" in runner
    ...
    assert "rotate_knob_student.rsl_rl_ppo_cfg:RotateObjectStudentRslRlPpoCfg" in registry
